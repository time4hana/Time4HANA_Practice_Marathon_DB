...
char and nchar are fixed-length which will reserve storage space 
	for number of characters you specify even if you don't use up all that space.
varchar and nvarchar are variable-length which will only use up spaces 
	for the characters you store. It will not reserve storage like char or nchar.
nchar and nvarchar will take up twice as much storage space, 
	so it may be wise to use them only if you need Unicode support.
*/
INSERT into Customers VALUES ('ALFKI', 'Alfreds Futterkiste', 'Maria Anders', 'Sales Representative', 'Obere Str. 57', 'Berli', NULL, '12209', 'Germany', '030-0074321', '030-0076545'); 
...
INSERT into Customers VALUES ('AROUT', 'Around the Hor', 'Thomas Hardy', 'Sales Representative', '120 Hanover Sq.', 'London', NULL, 'WA1 1DP', 'UK', '(171) 555-7788', '(171) 555-6750'); 
...
INSERT into Customers VALUES ('BLAUS', 'Blauer See Delikatesse', 'Hanna Moos', 'Sales Representative', 'Forsterstr. 57', 'Mannheim', NULL, '68306', 'Germany', '0621-08460', '0621-08924'); 
...
INSERT into Customers VALUES ('BONAP', 'Bon app''', 'Laurence Lebiha', 'Owner', '12, rue des Bouchers', 'Marseille', NULL, '13008', 'France', '91.24.45.40', '91.24.45.41'); 
INSERT into Customers VALUES ('BOTTM', 'Bottom-Dollar Markets', 'Elizabeth Lincol', 'Accounting Manager', '23 Tsawassen Blvd.', 'Tsawasse', 'BC', 'T2F 8M4', 'Canada', '(604) 555-4729', '(604) 555-3745'); 
...
INSERT into Customers VALUES ('CACTU', 'Cactus Comidas para llevar', 'Patricio Simpso', 'Sales Agent', 'Cerrito 333', 'Buenos Aires', NULL, '1010', 'Argentina', '(1) 135-5555', '(1) 135-4892'); 
...
INSERT into Customers VALUES ('CHOPS', 'Chop-suey Chinese', 'Yang Wang', 'Owner', 'Hauptstr. 29', 'Ber', NULL, '3012', 'Switzerland', '0452-076545', NULL); 
...
INSERT into Customers VALUES ('CONSH', 'Consolidated Holdings', 'Elizabeth Brow', 'Sales Representative', 'Berkeley Gardens 12  Brewery', 'London', NULL, 'WX1 6LT', 'UK', '(171) 555-2282', '(171) 555-9199'); 
INSERT into Customers VALUES ('DRACD', 'Drachenblut Delikatesse', 'Sven Ottlieb', 'Order Administrator', 'Walserweg 21', 'Aache', NULL, '52066', 'Germany', '0241-039123', '0241-059428'); 
...
INSERT into Customers VALUES ('EASTC', 'Eastern Connectio', 'Ann Devo', 'Sales Agent', '35 King George', 'London', NULL, 'WX3 6FW', 'UK', '(171) 555-0297', '(171) 555-3373'); 
...
INSERT into Customers VALUES ('FOLKO', 'Folk och fä HB', 'Maria Larsso', 'Owner', 'Åkergatan 24', 'Bräcke', NULL, 'S-844 67', 'Sweden', '0695-34 67 21', NULL); 
INSERT into Customers VALUES ('FRANK', 'Frankenversand', 'Peter Franke', 'Marketing Manager', 'Berliner Platz 43', 'Münche', NULL, '80805', 'Germany', '089-0877310', '089-0877451'); 
INSERT into Customers VALUES ('FRANR', 'France restauratio', 'Carine Schmitt', 'Marketing Manager', '54, rue Royale', 'Nantes', NULL, '44000', 'France', '40.32.21.21', '40.32.21.20'); 
...
INSERT into Customers VALUES ('HUNGC', 'Hungry Coyote Import Store', 'Yoshi Latimer', 'Sales Representative', 'City Center Plaza 516 Main St.', 'Elgi', 'OR', '97827', 'USA', '(503) 555-6874', '(503) 555-2376'); 
...
INSERT into Customers VALUES ('KOENE', 'Königlich Esse', 'Philip Cramer', 'Sales Associate', 'Maubelstr. 90', 'Brandenburg', NULL, '14776', 'Germany', '0555-09876', NULL); 
...
INSERT into Customers VALUES ('LONEP', 'Lonesome Pine Restaurant', 'Fran Wilso', 'Sales Manager', '89 Chiaroscuro Rd.', 'Portland', 'OR', '97219', 'USA', '(503) 555-9573', '(503) 555-9646'); 
...
INSERT into Customers VALUES ('OLDWO', 'Old World Delicatesse', 'Rene Phillips', 'Sales Representative', '2743 Bering St.', 'Anchorage', 'AK', '99508', 'USA', '(907) 555-7584', '(907) 555-2880'); 
INSERT into Customers VALUES ('OTTIK', 'Ottilies Käselade', 'Henriette Pfalzheim', 'Owner', 'Mehrheimerstr. 369', 'Köl', NULL, '50739', 'Germany', '0221-0644327', '0221-0765721'); 
...
INSERT into Customers VALUES ('RATTC', 'Rattlesnake Canyon Grocery', 'Paula Wilso', 'Assistant Sales Representative', '2817 Milton Dr.', 'Albuquerque', 'NM', '87110', 'USA', '(505) 555-5939', '(505) 555-3620'); 
...
INSERT into Customers VALUES ('SANTG', 'Santé Gourmet', 'Jonas Bergulfse', 'Owner', 'Erling Skakkes gate 78', 'Staver', NULL, '4110', 'Norway', '07-98 92 35', '07-98 92 47'); 
...
INSERT into Customers VALUES ('SIMOB', 'Simons bistro', 'Jytte Peterse', 'Owner', 'Vinbæltet 34', 'Kobenhav', NULL, '1734', 'Denmark', '31 12 34 56', '31 13 35 57'); 
INSERT into Customers VALUES ('SPECD', 'Spécialités du monde', 'Dominique Perrier', 'Marketing Manager', '25, rue Lauristo', 'Paris', NULL, '75016', 'France', '(1) 47.55.60.10', '(1) 47.55.60.20'); 
...
INSERT into Customers VALUES ('SUPRD', 'Suprêmes délices', 'Pascale Cartrai', 'Accounting Manager', 'Boulevard Tirou, 255', 'Charleroi', NULL, 'B-6000', 'Belgium', '(071) 23 67 22 20', '(071) 23 67 22 21'); 
INSERT into Customers VALUES ('THEBI', 'The Big Cheese', 'Liz Nixo', 'Marketing Manager', '89 Jefferson Way Suite 2', 'Portland', 'OR', '97201', 'USA', '(503) 555-3612', NULL); 
...
INSERT into Customers VALUES ('TOMSP', 'Toms Spezialitäte', 'Karin Josephs', 'Marketing Manager', 'Luisenstr. 48', 'Münster', NULL, '44087', 'Germany', '0251-031259', '0251-035695'); 
...
INSERT into Customers VALUES ('VAFFE', 'Vaffeljernet', 'Palle Ibse', 'Sales Manager', 'Smagsloget 45', 'Århus', NULL, '8200', 'Denmark', '86 21 32 43', '86 22 33 44'); 
INSERT into Customers VALUES ('VICTE', 'Victuailles en stock', 'Mary Saveley', 'Sales Agent', '2, rue du Commerce', 'Lyo', NULL, '69004', 'France', '78.32.54.86', '78.32.54.87'); 
...
INSERT into Customers VALUES ('WILMK', 'Wilman Kala', 'Matti Karttune', 'Owner/Marketing Assistant', 'Keskuskatu 45', 'Helsinki', NULL, '21240', 'Finland', '90-224 8858', '90-224 8858'); 
